...
--
-- Table structure for table `hotellingactivitydistribution`
--
...
--
-- Dumping data for table `hotellingactivitydistribution`
--

LOCK TABLES `hotellingactivitydistribution` WRITE;
/*!40000 ALTER TABLE `hotellingactivitydistribution` DISABLE KEYS */;
/*!40000 ALTER TABLE `hotellingactivitydistribution` ENABLE KEYS */;
UNLOCK TABLES;
