...
--
-- Table structure for table `offnetworklink`
--

DROP TABLE IF EXISTS `offnetworklink`;
...
--
-- Dumping data for table `offnetworklink`
--

LOCK TABLES `offnetworklink` WRITE;
/*!40000 ALTER TABLE `offnetworklink` DISABLE KEYS */;
/*!40000 ALTER TABLE `offnetworklink` ENABLE KEYS */;
UNLOCK TABLES;
