...
--
-- Table structure for table `onroadretrofit`
--

DROP TABLE IF EXISTS `onroadretrofit`;
...
--
-- Dumping data for table `onroadretrofit`
--

LOCK TABLES `onroadretrofit` WRITE;
/*!40000 ALTER TABLE `onroadretrofit` DISABLE KEYS */;
/*!40000 ALTER TABLE `onroadretrofit` ENABLE KEYS */;
UNLOCK TABLES;
